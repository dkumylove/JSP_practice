...
<body>
	...
	<!-- 
		set : 변수선언 (setAttribute())
		 var : 변수명
		 value : 값
		 scope : 저장영역 -> 기본값 : page영역
	-->
	
	<c:set var="directVar" value="100" scope="request"/>
	<c:set var="elVar" value="${directVar mod 5 }"/>
	<c:set var="deteVar" value="<%=new Date() %>"/>
	...
	<h2>Map 컬렉션 이용하기</h2>
	<%
		// 다른차닙의 여러가지 값을 저장하기가 용이하다.
		// 	- 리스트. pageDto
		// ajax, petch를 이용할 경우 -> 데이터만 전달 -> 스크립트에서 데이터를 파싱하여 화면을 다시 그려주어야 한다.
	...
	<!-- map는 변수로 선언만하고 영역에 저장하지 않았기 때문에 el문법으로 사용할수 없다. -->
